...
export const RESOURCES: Resource[] = [
 ...
 },
 {
  ...
  pages: 14,
  summary:
   'A real 9-month case study of an NC wholesaler who stopped giving away his best deals and kept one — netting $104K profit on his first flip using Southern Cities\'s execution stack (the Bid-Ready Deal Pack + Active Oversight services). He didn\'t learn construction. He didn\'t pick up a hammer. He underwrote the deal, approved milestones, signed the checks — Southern Cities ran the build. Full P&L disclosed, honest math on capital and risk, decision framework for which deals to keep vs. assign.',
  includes: [
