...
export const RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    pages: 14,
    summary:
      'A real 9-month case study of an NC wholesaler who stopped giving away his best deals and kept one — netting $104K profit on his first flip using SCC\'s execution stack (CO1 Execution Review + CO3 Active Oversight). He didn\'t learn construction. He didn\'t pick up a hammer. He underwrote the deal, approved milestones, signed the checks — SCC ran the build. Full P&L disclosed, honest math on capital and risk, decision framework for which deals to keep vs. assign.',
    includes: [
      ...
      'How SCC runs the execution side (CO1 + CO3 + CO4 explained)',
      '5-rule decision framework for which deals to keep vs. assign',
      'Three CTA doors: CO1 Execution Review, Build Desk membership, founder strategy call',
    ],
