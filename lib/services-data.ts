...
const realtorServices: AvatarPageData = {
  ...
  recurringIntro:
    'If you have steady listing and deal volume, Southern Cities also offers a lighter recurring support option for repeated inspection and listing-prep questions.',
  ongoingSupport: [
    {
      ...
      details: ['Up to 3 inspection or listing-prep reviews each month', 'Priority support on active listing questions', 'Pricing and repair guidance', '1 rush item each month'],
      fit: 'They are paying monthly to avoid deals and listings slowing down because repair questions stay vague too long.',
      purchaseType: 'review',
