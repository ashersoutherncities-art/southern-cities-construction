...
const homeownerServices: AvatarPageData = {
  ...
  buy: [
    ...
    {
      title: 'Homeowner Budget Estimate',
  ...
  buy: [
    {
      ...
      summary: 'A pre-execution review for investors who need a clearer read on a property, project, or decision before moving forward.',
    ...
    {
      title: 'Investor Rehab Budget Review',
...
const developerServices: AvatarPageData = {
  ...
  review: [
    {
      title: 'Early Project Feasibility Review',
    ...
    },
    {
      ...
      purchaseType: 'review',
      cta: 'Request Budget & Scope Review',
      ctaHref: '#contact',
    },
  ],
  quote: [
