...
export const CART_PRODUCTS: Record<string, ConstructionCartProduct> = {
  ...
  'listing-transaction-package': {
    ...
    price: 179900,
    priceLabel: '$1,799 flat per listing',
    description: 'The full listing-side construction co-pilot: Pre-Listing Valuation + Construction Confidence Sheet + Prep PM coordination call + Inspection Review + Repair Credit Letter + Repair Verification Visit. Saves ~$250 vs à la carte.',
    checkoutAmount: '1799',
  },
  'buyer-transaction-package': {
    ...
    price: 159900,
    priceLabel: '$1,599 flat per deal',
    description: 'The full buyer-side construction co-pilot: Buyer-Side Property Read + Negotiation Strategy Read + Inspection Review + Repair Scope Letter + Repair Verification Visit + Year-1 Priority Repair Plan. Saves ~$300 vs à la carte.',
    checkoutAmount: '1599',
  },
  'per-deal-copilot': {
    ...
    description: 'Construction co-pilot for the entire deal — listing or buying. One fixed price, full process coverage. Easy mental model: no à la carte decision-making per step.',
    checkoutAmount: '1499',
  },
};
