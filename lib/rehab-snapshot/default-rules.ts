...
export const DEFAULT_ESTIMATE_RULES: EstimateRuleRecord[] = [
  ...
  { rule_name: 'timeline-structural', category: 'timeline_risk', condition_json: { any_fields: ['structural', 'foundation'], label: 'Structural or foundation work' }, low_value: 4, high_value: 16, unit: 'weeks', active: true },
