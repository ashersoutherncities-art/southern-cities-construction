            ...
            <div className="hidden lg:flex items-center gap-0.5 xl:gap-1">
              {PRIMARY_LINKS.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="px-2.5 xl:px-3 py-2 rounded-lg text-[13px] xl:text-[13.5px] font-semibold text-white/90 hover:text-white hover:bg-white/10 transition-colors duration-200 whitespace-nowrap"
                >
                  {link.label}
                </Link>
              ))}
