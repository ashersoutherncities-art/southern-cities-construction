        ...
        <div className="container-pro">
          <div className="flex h-20 lg:h-[84px] items-center justify-between gap-6">
            ...
            <div className="hidden md:flex items-center gap-1 lg:gap-1.5">
              {PRIMARY_LINKS.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="px-3 py-2 rounded-lg text-[13px] lg:text-[14px] font-medium text-white/75 hover:text-white transition-colors duration-200 whitespace-nowrap"
                >
                  {link.label}
                </Link>
              ))}
              <CartNavLink className="px-3 py-2 rounded-lg text-[13px] lg:text-[14px] font-medium text-white/75 hover:text-white transition-colors duration-200 whitespace-nowrap hidden lg:inline-flex" />
              <a
                href="https://clients.southerncitiesconstruction.com"
                target="_blank"
                rel="noopener noreferrer"
                className="ml-1 inline-flex items-center gap-1.5 rounded-full bg-white/[0.08] hover:bg-white/[0.14] border border-white/12 text-white px-4 lg:px-5 py-2.5 text-[13px] lg:text-sm font-semibold transition-all duration-200 whitespace-nowrap"
              >
                Client Portal
              ...
              <Link
                href="/#contact"
                className="ml-1 inline-flex items-center gap-1.5 rounded-full bg-orange hover:bg-orange-500 text-white px-5 lg:px-6 py-2.5 text-[13px] lg:text-sm font-semibold shadow-glow-orange transition-all duration-200 whitespace-nowrap"
              >
                Request Quote
              </Link>
            </div>
            ...
            <button
              ...
              className="md:hidden -mr-2 p-2 text-white rounded-lg hover:bg-white/5"
