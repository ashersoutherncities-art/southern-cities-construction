...
`}</style>
      ...
      <section className="border-b border-stone-200 bg-white py-14 sm:py-16">
        <div className="container-pro grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[24px] border border-stone-200 bg-white p-6 shadow-elev-1">
            <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-orange">Ready when your project is</p>
            <p className="mt-4 text-[15px] leading-relaxed text-stone-700">
              When you need one company to own the whole job &mdash; permits, scope, subs, schedule, and delivery &mdash; this is the front door. A licensed NC General Contractor runs the build end to end, so you&rsquo;re not stitching together piecemeal help.
            </p>
