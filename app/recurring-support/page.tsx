    ...
    cards: [
      {
        ...
        tag: 'Solo agents',
        price: '$299/mo',
        who: 'Solo agents who hit a few construction questions a month.',
        problem: 'Best when the occasional deal surfaces a repair or inspection question that stalls your client.',
        creditSummary: 'Includes up to 3 inspection or listing reviews each month.',
        creditUses: ['inspection reviews', 'pre-listing prep reviews', 'repair questions', 'listing readiness questions'],
        simpleFlow: 'Send it, we review it, you get clear next steps.',
        turnaround: '24-hour response SLA. Quick contracting & pricing questions on call, uncapped.',
        cta: 'Review Realtor Solo',
      ...
      },
      {
        ...
        tag: 'Most common',
        price: '$649/mo',
        who: 'Small teams (3–10 agents) with recurring deal and listing questions.',
        problem: 'Best when the same repair, inspection, and pricing questions keep coming up across the team.',
        creditSummary: 'Includes up to 10 inspection or listing reviews each month.',
        creditUses: ['inspection reviews', 'pre-listing prep reviews', 'repair questions', 'listing readiness questions', 'shared team access (3–10 agents)'],
        simpleFlow: 'Send it, we review it, you get clear next steps.',
        turnaround: '1 business day response, same-day triage on urgent items. Quick pricing questions on call, uncapped.',
        cta: 'Review Realtor Team',
        href: '/services/realtors/realtor-team',
      },
      {
        name: 'Brokerage Pro',
        tag: 'Brokerages (10+ agents)',
        price: '$2,499/mo',
        who: 'Brokerages with 10+ agents needing agency-wide support.',
        problem: 'Best when the whole agency needs a licensed GC on call and a monthly cap would get in the way.',
        creditSummary: 'Unlimited inspection and listing reviews.',
        creditUses: ['inspection reviews', 'pre-listing prep reviews', 'repair questions', 'listing readiness questions', 'dedicated GC Support Specialist'],
        simpleFlow: 'Send it, we review it, you get clear next steps.',
        turnaround: '4-hour urgent SLA. Dedicated GC Support Specialist + quarterly business review.',
        cta: 'Review Brokerage Pro',
