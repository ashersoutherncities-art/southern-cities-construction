...
const LEAD_MAGNET_LPS: LeadMagnetLpConfig[] = [
  ...
  },
  {
    ...
    insideBullets: [
      ...
      'How Southern Cities runs the execution side — the Bid-Ready Deal Pack, Active Oversight, and Investor-Led Build explained, with license-level risk allocation',
