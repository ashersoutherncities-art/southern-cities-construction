...
const FEE_BASED_FIXED: ServiceCard[] = [
  ...
  },
  {
    ...
    description: 'We review inspection issues, sort the real problems from the noise, and help define the repair path fast.',
    forWho: 'For realtors and buyers trying to keep a deal alive after the inspection report comes back and someone needs to say what matters now.',
    deliverables: [
      'Inspection issue review',
      'Repair-scope recommendation',
      'Fast starting assessment',
      'Priority item breakdown',
  ...
  },
  {
    ...
    description: 'We walk the property, review the condition, and tell you what needs to happen next before you waste money in the wrong place.',
    forWho: 'For homeowners who need a real starting point before taking on repairs or renovation work and want a contractor-side opinion first.',
    deliverables: [
...
const PROJECT_SUPPORT_SERVICES: ServiceCard[] = [
  ...
  },
  {
    ...
    description: 'We review inspection findings and give you a clear repair path so you can move the deal forward with better construction-side clarity.',
    forWho: 'For realtors who need fast construction-side guidance after an inspection report and need something practical to bring back to the client.',
    deliverables: [
      'Inspection report review',
      'Repair-scope recommendation',
      'Timeline and cost range estimate',
      'Priority issue callout',
