...
export const actionRoutes: ActionRoute[] = [
  ...
  },
  {
    ...
    mode: 'subscribe',
    priceLabel: '$899/mo',
    bullets: ['Up to 4 permit or admin requests each month, each meaning 1 permit filing task, correction response, inspection scheduling task, or status follow-up sequence', 'Inspection scheduling support', 'Correction follow-up support', 'Permit status coordination on active files'],
  ...
  },
  {
    ...
    mode: 'subscribe',
    priceLabel: '$1,750/mo',
    bullets: ['Up to 8 support requests each month, each meaning 1 clearly scoped admin, permit, inspection, or documentation task', 'Permit and admin support', 'Inspection coordination', 'Documentation and follow-up support'],
  ...
  },
  {
    ...
    bullets: ['Weekly check-in', 'Up to 12 support requests each month, each meaning 1 clearly scoped admin, permit, inspection, or documentation task', 'Priority permit and inspection coordination', 'Documentation and follow-up support across active jobs'],
