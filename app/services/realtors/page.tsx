        ...
        <div className="container-pro">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-extrabold tracking-tight text-navy sm:text-4xl">
              Team support should be sold separately from agent plans.
            </h2>
            <p className="mt-4 text-base leading-relaxed text-stone-700 sm:text-lg">
              If multiple agents keep running into the same inspection, repair, and listing-prep questions, use a pooled team plan instead of trying to force that into an individual agent support plan.
            </p>
          </div>

          <div className="mt-8 flex justify-center">
            <div className="flex h-full w-full max-w-[420px] flex-col rounded-[22px] border border-stone-200 bg-stone-50 p-6 shadow-elev-1">
              ...
              <h3 className="text-[22px] font-extrabold leading-tight tracking-tight text-navy">{teamPlan.title}</h3>
