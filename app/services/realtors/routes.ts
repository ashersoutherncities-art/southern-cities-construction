...
export const actionRoutes: ActionRoute[] = [
  ...
  },
  {
    ...
    mode: 'subscribe',
    priceLabel: '$649/mo',
    bullets: ['Up to 4 active deal reviews each month, each covering 1 inspection, repair, or deal-side construction decision file', 'Inspection report review and repair-priority guidance', 'Up to 2 pricing-direction requests each month, each meaning 1 rough repair or prep-cost opinion for 1 property', 'Written summaries for client conversations'],
  ...
  },
  {
    ...
    mode: 'subscribe',
    priceLabel: '$649/mo',
    bullets: ['Up to 4 listing-prep reviews each month, each covering 1 property prep decision set before listing', 'Repair vs leave-alone guidance', 'Prep-priority and sequencing notes', 'Up to 2 follow-up clarifications per property, meaning 2 short follow-up questions after the initial listing-prep review'],
