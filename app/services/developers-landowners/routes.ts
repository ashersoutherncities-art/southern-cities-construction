...
export const actionRoutes: ActionRoute[] = [
  ...
  },
  {
    ...
    mode: 'subscribe',
    priceLabel: '$1,250/mo',
    bullets: ['Up to 2 active project reviews each month, each covering 1 project status review with milestone, risk, and next-step guidance', 'Milestone check-ins', 'Permit-path and coordination guidance', 'Risk and next-step summaries'],
  ...
  },
  {
    ...
    bullets: ['Weekly oversight touchpoint', 'Up to 4 active project reviews each month, each covering 1 project status review with milestone, risk, and next-step guidance', 'Budget and scope review support', 'Milestone and risk summaries'],
