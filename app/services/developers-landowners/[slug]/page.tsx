...
export default function DeveloperActionPage({ params }: { params: { slug: string } }) {
        ...
        <div className="container-pro grid gap-6 lg:grid-cols-[0.72fr_1.28fr]">
          ...
          <div className="rounded-[24px] border border-stone-200 bg-white p-6 shadow-elev-1">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link href="/services/industry-partners#developers" className="inline-flex items-center justify-center rounded-full border border-stone-300 bg-white px-6 py-3 text-sm font-semibold text-navy transition hover:border-orange hover:text-orange">
                Developer Services
              </Link>
            </div>
          </div>
