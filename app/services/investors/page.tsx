    ...
    products: [
      {
        ...
        covers: [
          ...
          'We do NOT pull permits or run the job',
        ],
      },
      {
        name: 'Owner-Controlled Build, GC-Led',
        description: 'You stay involved while Southern Cities provides licensed GC structure, controls, and execution support.',
        href: '/services/investors/owner-controlled-construction-gc-led',
        primaryCta: 'Request Review',
        highlighted: true,
        covers: [
          'Owner remains active in decisions',
      ...
      {
        name: 'Full Execution',
        description: 'Southern Cities takes a heavier role when the project needs full management or full contracting.',
        ...
        covers: [
          ...
          'Best for complex or higher-risk jobs',
          'End-to-end execution when needed',
        ],
      },
    ],
  },
