...
const DECISION_PAGE_CONFIGS: Record<string, DecisionPageConfig> = {
  ...
  'investors:contractor-fit-consultation': {
    headline: 'Know What Kind of Contractor This Project Actually Needs',
    subheadline: 'What kind of contractor fits, and why — before hiring conversations start.',
    whenToUse: ['Before any hiring conversations', 'When unsure if you need a GC, sub, or handyman', 'When the project complexity is unclear', 'Before bidding starts'],
    whatThisDoes: ['Determines the contractor profile this project needs', 'Explains WHY that profile fits', 'Flags wrong-fit setups to avoid', 'Gives hiring direction for what to look for'],
    included: ['Project review for contractor-profile fit', 'Recommended profile (kind, license level, specialty)', 'Written reasoning', 'Wrong-fit callouts'],
    ...
    nextSteps: ['Submit project details', 'We assess the contractor fit', 'You get a profile recommendation with reasoning'],
  },
