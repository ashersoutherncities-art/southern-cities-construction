...
const DECISION_PAGE_OVERRIDES: Record<string, DecisionPageOverride> = {
  ...
  'investors:contractor-fit-consultation': {
    ...
    addOnBundle: {
      ...
      heading: 'Pair with Contractor Match + Permit & Compliance Review — save $348',
      description: 'Once we tell you what kinds of contractors you need, the obvious next move is to actually go find them and run the bids — and check the permit path. Bundle the Fit Consultation ($349) with Contractor Match & Bid Coordination ($1,499) and the Permit & Local Compliance Review ($399) for $1,899 total — $348 off.',
      bullets: [
        ...
        '$348 off vs buying them separately',
        'All kicked off in the same intake — no second form to fill out',
      ],
  ...
  'investors:draw-review-support': {
    headline: 'We manage every draw on your project',
    subheadline: 'One flat fee covers all draws — we run them, submit them for you, and collect the receipts and proof of payment.',
    whenToUse: ['When you want the whole draw process off your plate', 'When chasing receipts and filing submissions is eating time', 'When the lender wants photos and proof on their schedule'],
    whatThisDoes: ['Runs every draw for the project', 'Submits draws on your behalf (we can take your logins)', 'Captures inspection photos as required (separate fee)', 'Collects all receipts and proof of payment'],
    deliverable: [
      { heading: 'We run each draw', items: ['Draw request prepared and submitted on your behalf', 'Progress documented against the payment schedule'] },
      { heading: 'Documentation handled', items: ['Inspection photos captured as required (separate fee)', 'Receipts + proof of payment collected from you'] },
      { heading: 'You stay funded', items: ['Draws filed on the lender\'s schedule', 'One flat $599 covers every draw on the project'] },
    ],
    testimonial: { quote: 'Permits and paperwork were eating up my week. They took it off my plate and the jobs stopped stalling.', name: 'Taquan P.', role: 'Wholesaler' },
  },
