...
const DECISION_PAGE_OVERRIDES: Record<string, DecisionPageOverride> = {
  'investors:investor-review': {
    headline: 'Review the deal before you commit',
    ...
    deliverable: [
      { heading: 'Risk callouts', items: ['Foundation cracking — east wall', 'Permit gap: ADU not zoned', 'Roof: ~3 years left, $14K replacement'] },
      { heading: 'Scope validation', items: ['HVAC line missing from budget', 'Tile allowance light by $4–6K'] },
      { heading: 'Recommendation', items: ['Renegotiate by $22K or walk'] },
    ],
  ...
  'investors:budget-review': {
    ...
    subheadline: 'Make sure your budget actually matches the scope before you cut the check.',
    ...
    deliverable: [
      { heading: 'Scope gaps found', items: ['HVAC line missing — ~$8K', 'Tile allowance light by $4–6K', 'Demo + dump fees not included'] },
      { heading: 'Budget pressure points', items: ['Plumbing: 18% below market', 'Permit fees absent — $1.4K'] },
      { heading: 'Recommendation', items: ['Rebuild budget to $86K min before signing'] },
    ],
