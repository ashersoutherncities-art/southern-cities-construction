...
const DECISION_PAGE_CONFIGS: Record<string, DecisionPageConfig> = {
  ...
  'investors:contractor-fit-consultation': {
    headline: 'Choose the Right Contractor',
    subheadline: 'Know who to trust and who to avoid before you hire.',
    whenToUse: ['Comparing contractors', 'Reviewing bids', 'Unsure who to hire'],
    whatThisDoes: ['Reviews contractor capability', 'Compares bids', 'Flags risks', 'Provides recommendation'],
    included: ['Contractor review', 'Bid comparison', 'Risk flags', 'Recommendation'],
    notIncluded: ['Not contractor sourcing', 'Not bid coordination', 'Not project management'],
    provide: ['Address', 'Photos', 'Scope or rehab plan', 'Contractor bids or notes'],
    nextSteps: ['Submit project details', 'We review contractor fit', 'You get a recommendation'],
  },
