...
const COMPARISON_ROWS_GC_GRADE_INSPECTION: ComparisonRow[] = [
  ...
  { label: 'Southern Cities — GC-Grade Property Inspection', cost: '$899 standard · $1,199 rush', time: '3–5 days · 24–48 hr rush', bias: 'None — flat fee', licensed: true, highlight: true },
];
...
const LANDING_PAGES: LandingPageConfig[] = [
  ...
  },
  {
    ...
    heroSubheadline:
      'A licensed inspector visits the property AND a licensed NC general contractor reads the inspection through a construction lens — item-by-item severity, real cost ranges per finding, paste-ready repair-request language, and a negotiation framing memo. Statewide NC, two turnaround tiers, single fixed price.',
    problemHeadline: 'Why a standard inspection isn\'t enough',
    problemIntro: 'A home inspector identifies issues. They\'re legally cautioned against giving cost ranges. So the realtor has to bridge that gap themselves — guessing at numbers, calling contractor friends, or just hoping the buyer doesn\'t panic.',
    problemCards: [
      { title: 'Inspector says "consult a professional"', body: '47 items flagged, zero dollar amounts. Realtor has to invent the budget.', tone: 'red' },
      { title: 'Buyer panics on raw inspection report', body: 'Every flagged item feels critical. Cosmetic noise drowns out real items.', tone: 'amber' },
      { title: 'Repair-request math is a guess', body: 'Without real cost ranges, the buyer\'s ask is too high or too low.', tone: 'rose' },
      { title: 'Two products for what should be one', body: 'Inspection + contractor estimate = double the cost, double the wait, mixed bias.', tone: 'orange' },
    ],
    getHeadline: 'What you actually get',
    getBullets: [
      { title: 'Licensed inspector on-site', detail: 'Real visit, real eyes on the property, real inspection report. Not a desk review.' },
      { title: 'GC-grade item-by-item analysis', detail: 'Every finding rated Critical / Important / Cosmetic by a licensed NC GC — not the inspector\'s CYA default of "consult a pro."' },
      { title: 'Real dollar cost ranges per item', detail: 'Specific ranges like $4K–8K, not "budget to repair." This is what inspectors are legally cautioned against — we can give it.' },
      { title: 'Paste-ready Repair Request Language', detail: 'Clean email-format text the agent forwards to the other side. No rewriting.' },
      { title: 'Negotiation framing memo', detail: 'Counter-offer math, walk-away triggers, what to push on vs drop. Construction context for the strategy conversation.' },
    ],
    deliverableTitle: 'GC-Grade Property Inspection',
    deliverableSubtitle: '123 Main St · Charlotte, NC',
    deliverable: [
      ...
      { heading: 'GC analysis layer', items: ['Critical (3): foundation crack — $4K–8K · HVAC end-of-life — $8K–14K · roof remaining life — $14K–22K', 'Important (5): galvanized plumbing partial — $4K–8K · knob-and-tube remnants — $3K–6K · etc.', 'Cosmetic (12): bundled, no deal impact, < $3K total'] },
      { heading: 'Negotiation framing memo', items: ['"Total Year-1 repair burden: $30K–55K. List price assumes buyer absorbs that. Reasonable repair-credit ask: $22K–28K. Walk-away threshold: if seller refuses to address roof or foundation."'] },
      { heading: 'Ready-to-send Repair Request Language (paste-ready)', items: ['"Based on inspection findings, we are requesting the following repairs or credits prior to closing: ..."', '"1. Foundation crack at east wall — investigation + repair. Reasonable credit: $6,000."', '"2. HVAC system replacement — 2010 unit at end of useful life. Reasonable credit: $11,000."', '"3. Knob-and-tube wiring remediation — full removal + Romex replacement. Reasonable credit: $4,500."', '"Total credit request: $21,500. Open to seller-completed repairs by licensed trades prior to closing in lieu of credit."'] },
    ],
    processSteps: [
    ...
    valueStack: [
      ...
      'GC analysis layer (item-by-item severity)',
      'Real dollar cost ranges per finding',
      ...
      'One product, one purchase, one document',
      'Money-back if the deliverable doesn\'t hold up',
    ],
    finalHeadline: 'Stop bridging the gap between inspector and contractor yourself.',
    finalSubhead: 'One licensed-inspector on-site visit, one GC-grade analysis layer, one fixed price. $899 standard or $1,199 rush. The flagship realtor product.',
    faqs: [
      { q: 'How is this different from a standard home inspection?', a: 'A standard home inspection identifies issues but legally avoids cost ranges ("consult a professional"). This product gives you the inspection PLUS a licensed NC GC adding real dollar ranges per finding, severity ratings, paste-ready repair-request language, and a negotiation memo. Two layers, one product, one price.' },
      { q: 'Who actually performs the inspection?', a: 'A licensed inspector visits the property on our behalf. The inspection report is generated in standard format. Then a licensed NC GC adds the construction analysis layer that inspectors legally cannot provide. The deliverable is a single document with both.' },
      ...
      { q: 'Why is this $899 when a home inspection alone is $400–700?', a: 'Because you\'re getting the inspection PLUS the GC analysis layer. Real cost ranges, severity ratings, paste-ready language, negotiation memo. The alternative is buying the inspection ($500) PLUS a contractor estimate ($500–1,000) PLUS doing the synthesis yourself — that\'s the labor you\'re paying us to do once, at a fixed price.' },
      { q: 'Does this replace Repair Credit Letter or Repair Scope Letter?', a: 'No. This is the inspection + budget product. The $349 letters are GC-signed formal documents on SCC letterhead for negotiation moments. Many agents buy this + a letter when they need both the analysis AND a formal signed document.' },
  ...
  },
  {
    ...
    heroHeadlinePost: '.',
    heroSubheadline:
      'GC-Grade Property Inspection + Pre-Listing Valuation + Construction Confidence Sheet + Prep PM coordination call + Inspection Review + Repair Credit Letter + Repair Verification Visit. One fixed price covers the full listing-side construction co-pilot, anchored by the flagship on-site GC-Grade Inspection.',
    ...
    getBullets: [
      { title: 'GC-Grade Property Inspection ($899) — flagship', detail: 'On-site licensed inspection + GC-grade analysis layer with real cost ranges. Buy it as part of the package or à la carte.' },
    ...
    deliverable: [
      { heading: 'Phase 1: Pre-listing', items: ['GC-Grade Property Inspection (on-site)', 'Pre-Listing Construction Valuation', 'Construction Confidence Sheet', 'Listing Prep PM coordination call'] },
    ...
    valueStack: [
      'GC-Grade Property Inspection (flagship)',
    ...
    finalSubhead: 'Listing Transaction Package, $2,299 flat per listing. Includes the flagship GC-Grade Property Inspection and 6 other products. Saves ~$245 vs à la carte.',
    faqs: [
  ...
  },
  {
    ...
    deliverable: [
      { heading: 'Phase 1: Pre-offer / inspection', items: ['GC-Grade Property Inspection (on-site)'] },
    ...
    finalHeadline: 'One purchase. Full construction-side coverage. Done.',
    finalSubhead: 'Buyer Transaction Package, $1,999 flat per deal. Includes the flagship GC-Grade Property Inspection and 5 other products. Saves ~$395 vs à la carte.',
    faqs: [
