...
const LANDING_PAGES: LandingPageConfig[] = [
  ...
  },
  {
    ...
    deliverable: [
      { heading: 'Phase 1: Pre-listing', items: ['Inspection + GC Budget Report (on-site)', 'Pre-Listing Construction Valuation', 'Construction Confidence Sheet', 'Listing Prep PM coordination call'] },
