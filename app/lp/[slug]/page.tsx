...
const COMPARISON_ROWS_PRE_LISTING_VALUATION: ComparisonRow[] = [
  ...
  { label: 'Southern Cities — Pre-Listing Quick Audit', cost: '$299 (refunded on repair work)', time: '1 business day', bias: 'None — refundable fee', licensed: true, highlight: true },
];
...
const LANDING_PAGES: LandingPageConfig[] = [
  ...
  },
  {
    ...
    valueStack: [
      ...
      '$299 fee fully credited back on repair work over $1,000',
      'Licensed NC GC reads personally',
      '1 business day turnaround',
    ],
