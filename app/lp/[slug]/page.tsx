...
const COMPARISON_ROWS_GC_GRADE_INSPECTION: ComparisonRow[] = [
  { label: 'Standard home inspector', cost: '$400–700', time: '3–5 days', bias: 'Low — but legally cautioned from cost ranges', licensed: 'Inspector-licensed', highlight: false },
  { label: 'Inspector + separate contractor estimate', cost: '$700–1,500 total', time: '7–14 days', bias: 'Mixed (contractor wants the job)', licensed: 'Sometimes', highlight: false },
  { label: 'Hire a GC for a property review', cost: '$800–2,000', time: '3–7 days', bias: 'Low', licensed: true, highlight: false },
  { label: 'Southern Cities — Inspection + GC Budget Report', cost: '$899 standard · $1,199 rush', time: '3–5 days · 24–48 hr rush', bias: 'None — flat fee', licensed: true, highlight: true },
];
...
const COMPARISON_ROWS_PRE_LISTING_VALUATION: ComparisonRow[] = [
  { label: 'List without a GC read', cost: 'Free', time: '0', bias: 'High — surprises hit at inspection', licensed: false, highlight: false },
  { label: 'Pre-listing inspection (3rd-party inspector)', cost: '$400–700', time: '3–5 days', bias: 'Low — but no cost ranges or fix-skip calls', licensed: 'Inspector-licensed', highlight: false },
  { label: 'Contractor walkthrough', cost: 'Free', time: 'Days, if they reply', bias: 'High (they want the job)', licensed: 'Sometimes', highlight: false },
  { label: 'Southern Cities — Pre-Listing Audit', cost: '$649 (GC portion refunded on repair work)', time: 'Inspection + GC read', bias: 'None — licensed inspection', licensed: true, highlight: true },
];
...
const COMPARISON_ROWS_LISTING_PACKAGE: ComparisonRow[] = [
  { label: 'Buy 7 products à la carte', cost: '~$2,545 total', time: 'Per-product turnaround', bias: 'None — flat fees', licensed: true, highlight: false },
  ...
  { label: 'Southern Cities — Listing Transaction Package', cost: '$2,299 flat', time: 'Sequenced across the listing', bias: 'None — flat fee', licensed: true, highlight: true },
];

const COMPARISON_ROWS_BUYER_PACKAGE: ComparisonRow[] = [
  { label: 'Buy 6 products à la carte', cost: '~$2,395 total', time: 'Per-product turnaround', bias: 'None — flat fees', licensed: true, highlight: false },
  { label: 'Self-manage construction help', cost: '"Free" hidden hours', time: 'Drains your week', bias: 'High — no GC context', licensed: false, highlight: false },
...
const LANDING_PAGES: LandingPageConfig[] = [
  {
    ...
    priceLabel: 'Investor Execution Review',
    turnaround: '2 business days',
    audience: 'For residential investors',
    audienceTag: 'INVESTORS · DEAL REVIEW',
    heroEyebrow: 'Investor Execution Review',
    ...
    deliverableTitle: 'Investor Execution Review',
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How is this different from the Investor Execution Review?', a: 'The Execution Review is decision-grade — a rough range for underwriting a deal you do not own yet. This is bid-grade — a line-item audit for owners getting ready to build.' },
  ...
  },
  {
    ...
    priceLabel: 'Permit & Local Compliance Review',
    turnaround: '2 business days',
    audience: 'For residential investors',
    audienceTag: 'INVESTORS · PERMITS',
    heroEyebrow: 'Permit & Local Compliance Review',
    ...
    deliverableTitle: 'Permit & Local Compliance Review',
    deliverableSubtitle: '123 Main St · Charlotte, NC',
    deliverable: [
      {
  ...
  },
  {
    ...
    addOnBundle: {
      ...
      heading: 'Pair with Contractor Match + Permit & Compliance Review',
      description: 'Once we tell you what kinds of contractors you need, the next move is to actually go find them — and check the permit path. Bundle Contractor Fit Consultation ($349) + Contractor Match & Bid Coordination ($1,499) + Permit & Local Compliance Review ($399) for $1,899 — save $348.',
      bullets: [
        ...
        'Permit & Local Compliance Review — we check the permit path and local compliance',
        '$348 off vs buying separately',
        'All kicked off in the same intake — no second form',
      ],
      bundleProductKey: 'fit-plus-match-bundle',
      bundleLabel: 'Add Bundle — $1,899 (save $348)',
      bundlePriceLabel: '$1,899 bundle · normally $2,247',
      savingsBadge: 'Save $348',
    },
  },
  {
    slug: 'draw-review',
    productKey: 'draw-review-support',
    ctaLabel: 'Get Draw Management',
    price: '$599',
    priceAnchor: 'Stop chasing receipts and filing draws yourself',
    priceLabel: 'Draw Management',
    turnaround: 'Runs for the life of the project',
    audience: 'For residential investors',
    audienceTag: 'INVESTORS · DRAWS',
    heroEyebrow: 'Draw Management',
    heroHeadlinePre: 'We manage every draw so the',
    heroHeadlineHighlight: 'money',
    heroHeadlinePost: ' keeps flowing.',
    heroSubheadline:
      'We run every draw on your project — submit them for you (we can take your logins), capture the required inspection photos (separate fee), and collect all receipts and proof of payment. One flat $599 for the whole project.',
    ...
    getHeadline: 'What you actually get',
    getBullets: [
      { title: 'We run every draw', detail: 'Each draw prepared and submitted for you — we can take your logins, or you forward/upload.' },
      { title: 'Receipts + proof collected', detail: 'We gather all receipts and proof of payment so the draw file is clean.' },
      { title: 'Inspection photos as required', detail: 'Captured when the lender needs them (photo truck-time billed separately).' },
      { title: 'One flat fee, whole project', detail: '$599 covers every draw for the life of the project — no per-draw nickel-and-diming.' },
    ],
    deliverableTitle: 'Draw Management',
    ...
    deliverable: [
      ...
      },
      {
        ...
        items: ['Draw prepared + submitted on your behalf', 'Receipts + proof of payment collected and filed'],
      },
    ],
    processSteps: [
      { title: 'Set us up', detail: 'Share the project, lender/draw schedule, and portal logins (or forward each draw to us).' },
      { title: 'We run the draws', detail: 'We prepare, submit, and document every draw, capturing inspection photos as required.' },
      { title: 'You stay funded', detail: 'Draws filed on the lender’s schedule for the life of the project — one flat $599.' },
    ],
    testimonials: [
      {
        quote: 'Permits and paperwork were eating up my week. They took it off my plate and the jobs stopped stalling.',
    ...
    finalHeadline: 'Hand off the whole draw process.',
    finalSubhead: 'We manage every draw on your project for one flat $599 — filed for you, receipts collected, inspection photos captured as required.',
    faqs: [
      { q: 'What do you need from me?', a: 'The project details, your lender/draw schedule, and either portal logins so we can file for you or a way to forward each draw.' },
      { q: 'Does $599 cover every draw?', a: 'Yes. One flat $599 covers management of all draws on the project — not a single review.' },
      { q: 'What do I get?', a: 'We run every draw: prepare and submit it for you, collect receipts and proof of payment, and capture inspection photos as required (photo truck-time billed separately).' },
      { q: 'Is this lender approval?', a: 'No. We manage and submit your draws; the lender still approves each release.' },
      { q: 'Do you capture the inspection photos?', a: 'Yes, when the lender requires them. The on-site photo truck-time is billed separately.' },
      { q: 'Can you take my logins and file directly?', a: 'Yes — we can file draws directly through your lender portal, or you can forward/upload each one to us.' },
    ],
  },
  {
  ...
  },
  {
    ...
    getBullets: [
      ...
      { title: 'Draw Management ($599 flat)', detail: 'We run and submit every draw for the project — receipts and proof of payment collected.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'What if my client is selling, not buying?', a: 'Works either way — same analysis, just framed for the listing side. For pricing-driven analysis on listing decisions, see Pre-Listing Audit.' },
    ],
  ...
  },
  {
    ...
    ctaLabel: 'Book the Inspection + GC Budget Report',
    ...
    priceLabel: 'Inspection + GC Budget Report',
    ...
    heroEyebrow: '★ FLAGSHIP — Inspection + GC Budget Report',
    heroHeadlinePre: 'The inspection AND',
    heroHeadlineHighlight: 'the budget',
    heroHeadlinePost: ' — on one document.',
    heroSubheadline:
      'A licensed inspector visits the property AND a licensed NC general contractor turns the findings into a 3-tier estimate: MANDATORY items (code/loan-killers, 5–7 day fix guarantee), HIGH-ROI items (2× return cosmetics), and DISCLOSE & SKIP (formatted as an exact-dollar credit quote). Statewide NC, two turnaround tiers, single fixed price.',
    problemHeadline: 'Why a standard inspection isn\'t enough',
    problemIntro: 'A home inspector identifies issues. They\'re legally cautioned against giving cost ranges OR telling you which items matter. So the realtor has to bridge that gap themselves — guessing at numbers, calling contractor friends, or just hoping the buyer doesn\'t panic.',
    problemCards: [
      { title: 'Inspector says "consult a professional"', body: '47 items flagged, zero dollar amounts, no priority. Realtor has to invent the budget AND the priority.', tone: 'red' },
      { title: 'Buyer panics on raw inspection report', body: 'Every flagged item feels critical. Loan-killer code violations get drowned out in cosmetic noise.', tone: 'amber' },
      { title: 'Pre-listing spend goes to wrong items', body: 'Seller spends $15K on cosmetic upgrades that move price $5K. Loan-killer items stay broken.', tone: 'rose' },
      { title: 'Negotiation tilts wrong', body: 'Without real cost ranges, repair-credit math is gut-feel. Equity walks out the door during escrow.', tone: 'orange' },
    ],
    ...
    deliverableTitle: 'Inspection + GC Budget Report — 3-Tier Estimate',
    deliverableSubtitle: '123 Main St · Charlotte, NC',
    deliverable: [
    ...
    processSteps: [
      ...
      { title: 'Inspection happens on-site', detail: 'A licensed inspector visits the property. Standard 1–2 hour on-site walkthrough. Photos + findings captured.' },
      { title: 'GC analysis layer added', detail: 'A licensed NC GC reads the report through a construction lens, adds severity + cost ranges + paste-ready language + negotiation memo.' },
      { title: 'You get the complete report', detail: 'PDF in your inbox: inspection findings + GC analysis layer + ready-to-send Repair Request Language. 3–5 days standard, 24–48 hours rush.' },
    ],
    testimonials: [
      { quote: 'I stopped having to bridge the gap between the inspection and the budget myself. The GC layer does the work I used to spend hours on.', name: 'Madison M.', role: 'Buyer\'s Agent' },
      { quote: 'My buyer walked into negotiation with real numbers, not a panicked spreadsheet I made up. Closed at the right credit.', name: 'Jethro A.', role: 'Realtor' },
      { quote: 'The repair-request language alone saves me two hours of writing per deal. The negotiation memo is the cherry on top.', name: 'Trisha W.', role: 'Listing Agent' },
    ],
    notIncluded: [
      'Specialty inspections (sewer scope, septic, mold) — coordinated separately at additional cost',
      'GC-signed formal letter on letterhead — see Repair Credit Letter or Repair Scope Letter ($349)',
      'Listing-prep coordination — see Listing Prep PM',
      'Engineering / structural sign-off — coordinated separately if needed',
      'Re-inspection after seller repairs — see Repair Verification Visit ($249)',
    ],
    valueStack: [
      'Licensed inspector on-site visit',
      'Full home inspection report (standard format)',
      ...
      'Money-back if the deliverable doesn\'t hold up',
    ],
    ...
    addOnBundle: {
      ...
      bullets: [
        'Inspection + GC Budget Report (this product) included',
  ...
  },
  {
    ...
    ctaLabel: 'Get the Pre-Listing Audit',
    ctaLabelMid: 'See a Sample Audit',
    ctaLabelFinal: 'Get the Audit — $649',
    price: '$649 · GC portion credited on repair work',
    priceAnchor: 'The hidden equity loss most listings don\'t see coming',
    priceLabel: 'Pre-Listing Audit',
    turnaround: 'Licensed inspection + GC read',
    audience: 'For listing agents and sellers protecting equity before they list',
    audienceTag: 'LISTING AGENTS · SELLERS',
    heroEyebrow: 'Pre-Listing Audit',
    heroHeadlinePre: 'Find the',
    heroHeadlineHighlight: '$20K hidden equity loss',
    heroHeadlinePost: ' before the listing goes live.',
    heroSubheadline:
      'A licensed inspector visits the property AND a licensed NC general contractor turns the findings into a seller-side analysis — fix-vs-skip-vs-disclose on every condition item, a condition-adjusted price band, and repair-spend ROI math. Inspection ($400) + GC analysis ($249) = $649; the $249 GC portion is credited back if Southern Cities handles the repair work over $1,000.',
    ...
    problemCards: [
      { title: '"Surprise" repair items kill leverage', body: 'Buyer\'s inspector flags items the seller didn\'t prep for. Negotiation tilts hard. Equity walks out the door.', tone: 'red' },
      { title: 'Pre-listing spend goes to the wrong fixes', body: 'Seller drops $15K on cosmetic upgrades that move the price $5K. The structural items that DO move the price stay broken.', tone: 'amber' },
      { title: 'Listed at the wrong price for condition', body: 'Listed at comp ceiling without adjusting for real condition. Sits on market. Price reductions follow.', tone: 'rose' },
      { title: 'Loan-killer items discovered too late', body: 'Code violations the buyer\'s inspector catches stall the lender. Closing date slips. Deal dies.', tone: 'orange' },
    ],
    getHeadline: 'What you actually get',
    getBullets: [
      ...
      { title: 'GC portion ($249) credited', detail: 'The $249 GC-analysis portion is credited back if Southern Cities handles repair work over $1,000 afterward. The $400 inspection is a pass-through cost.' },
    ],
    deliverableTitle: 'Pre-Listing Audit',
    deliverableSubtitle: '123 Main St · Charlotte, NC',
    deliverable: [
      { heading: 'Items to FIX before listing (positive ROI)', items: ['HVAC: 2008 unit at end of life — replace pre-listing. Cost $10K, value lift $12–14K. Net gain.', 'Peeling paint on north elevation — FHA/VA flag if left. Cost $400, value lift $1–2K. Net gain.', 'Kitchen GFCI outlets missing — $200 fix, removes loan-killer item.'] },
      ...
      { heading: 'GC-portion credit', items: ['The $249 GC-analysis portion is credited back against any repair work over $1,000 you have Southern Cities handle (HVAC, etc.). The $400 inspection is a pass-through cost.'] },
    ],
    processSteps: [
      { title: 'Book the audit', detail: 'Property address, target date, any prior inspection if you have one, and the comp range you\'re considering.' },
      { title: 'Inspection + GC read', detail: 'A licensed inspector visits on-site; a licensed NC GC applies value-drag analysis and writes the pricing strategy.' },
      { title: 'You get the read', detail: 'Written deliverable ready to inform your CMA conversation with the seller.' },
    ],
    testimonials: [
    ...
    notIncluded: [
      ...
      'Not the 3-tier build budget — see Inspection + GC Budget Report',
    ],
    valueStack: [
      'Licensed inspector on-site ($400)',
      'GC seller analysis ($249)',
      'Fix / Skip / Disclose call per condition item',
      'Condition-adjusted price band (comp ceiling + construction-adjusted recommended list)',
      'Repair-spend ROI math (cost-to-fix vs value-lift)',
      'Loan-killer items flagged (FHA/VA appraiser flags, code violations)',
      'Disclosure-critical items list (RPDS-ready)',
      'GC portion ($249) credited back on repair work over $1,000',
    ],
    finalHeadline: 'Protect the equity before the listing goes live.',
    finalSubhead: 'A licensed inspection + GC seller analysis, $649 — the $249 GC portion credited back if Southern Cities handles the repairs afterward. Advice grounded in real condition, not photos.',
    faqs: [
      { q: 'How does the credit actually work?', a: 'You pay $649 upfront — a $400 licensed inspection plus a $249 GC seller analysis. If Southern Cities handles any repair work for that property over $1,000 after the audit (HVAC replacement, GFCI updates, roof patch, etc.), we credit the $249 GC portion against that invoice. The $400 inspection is a pass-through cost and is not credited.' },
      ...
      { q: 'How is this different from the Inspection + GC Budget Report ($899)?', a: 'This is the seller-side read: a licensed inspection plus a GC analysis of fix / skip / disclose and a condition-adjusted price band. The $899 Report is the buyer-or-seller flagship that adds the full 3-tier build budget (Mandatory / High-ROI / Disclose & Skip) with the GC committing to do the work at that number.' },
      { q: 'What if the home is in great condition?', a: 'You\'ll get that in writing — no fix items, list at comp ceiling. Confidence in a good number is part of what you\'re paying for. (And the $249 GC portion is still credited if you hire Southern Cities for repairs later.)' },
      { q: 'What do you need from me?', a: 'Property address, target inspection date, any prior inspection report if available, and the comp range you\'re considering.' },
  ...
  },
  {
    ...
    getBullets: [
      ...
      { title: 'Auto-generated from valuation data', detail: 'Free when bundled with Pre-Listing Audit; $99 standalone.' },
    ],
    ...
    notIncluded: [
      'Not a full Pre-Listing Audit (that\'s $649 and includes price band, value-drag items, strategy notes)',
  ...
  },
  {
    ...
    heroHeadlinePost: '.',
    heroSubheadline:
      'Inspection + GC Budget Report + Pre-Listing Valuation + Construction Confidence Sheet + Prep PM coordination call + Inspection Review + Repair Credit Letter + Repair Verification Visit. One fixed price covers the full listing-side construction co-pilot, anchored by the flagship on-site Inspection + GC Budget Report.',
    ...
    getBullets: [
      { title: 'Inspection + GC Budget Report ($899) — flagship', detail: 'On-site licensed inspection + GC-grade analysis layer with real cost ranges. Buy it as part of the package or à la carte.' },
      { title: 'Pre-Listing Audit ($649)', detail: 'Licensed inspection + GC seller analysis: condition-adjusted price band + value-drag items + pricing strategy. Use it to win the listing presentation.' },
    ...
    deliverableSubtitle: 'Full lifecycle coverage · $2,299 flat',
    deliverable: [
      { heading: 'Phase 1: Pre-listing', items: ['Inspection + GC Budget Report (on-site)', 'Pre-Listing Audit', 'Construction Confidence Sheet', 'Listing Prep PM coordination call'] },
      ...
      { heading: 'À la carte total', items: ['$899 + $649 + $99 + $249 + $299 + $349 + $249 = $2,793', 'Package price: $2,299 — saves ~$494'] },
    ],
    processSteps: [
    ...
    valueStack: [
      'Inspection + GC Budget Report (flagship)',
      'Pre-Listing Audit',
    ...
    finalSubhead: 'Listing Transaction Package, $2,299 flat per listing. Includes the flagship Inspection + GC Budget Report and 6 other products. Saves ~$245 vs à la carte.',
    faqs: [
  ...
  },
  {
    ...
    heroHeadlinePost: '.',
    heroSubheadline:
      'Inspection + GC Budget Report + Negotiation Strategy Read + Inspection Review + Repair Scope Letter + Repair Verification Visit + Year-1 Priority Repair Plan. One fixed price covers the full buyer-side construction co-pilot, anchored by the flagship on-site Inspection + GC Budget Report.',
    ...
    getHeadline: 'What\'s included in the package',
    getBullets: [
      { title: 'Inspection + GC Budget Report ($899) — flagship', detail: 'On-site licensed inspection + GC-grade analysis layer with real cost ranges, paste-ready repair-request language, and a negotiation framing memo.' },
    ...
    deliverableSubtitle: 'Full lifecycle coverage · $1,999 flat',
    deliverable: [
      { heading: 'Phase 1: Pre-offer / inspection', items: ['Inspection + GC Budget Report (on-site)'] },
    ...
    finalHeadline: 'One purchase. Full construction-side coverage. Done.',
    finalSubhead: 'Buyer Transaction Package, $1,999 flat per deal. Includes the flagship Inspection + GC Budget Report and 5 other products. Saves ~$395 vs à la carte.',
    faqs: [
