...
const LANDING_PAGES: LandingPageConfig[] = [
  ...
  },
  {
    ...
    price: '$349',
    priceAnchor: 'The wrong contractor can cost 20% of the build',
    ...
    heroHeadlinePost: ' for this project.',
    heroSubheadline:
      "A licensed-GC read on contractor fit, bid risk, and execution readiness — scheduled call + written follow-up. $349 flat.",
    problemHeadline: 'The wrong contractor is the most expensive mistake',
    problemIntro: "And the hardest to undo once you've signed.",
    problemCards: [
      { title: 'You hire on bad assumptions', body: 'The pitch sounds right; the execution doesn’t.', tone: 'red' },
      { title: 'Delivery model doesn’t fit the scope', body: 'GC, handyman, or self-managed — wrong choice costs you.', tone: 'amber' },
      { title: 'Bids look fine until they don’t', body: 'Soft scope and missing lines surface mid-build.', tone: 'rose' },
      { title: 'Wrong expectations get baked in', body: 'And every later decision is shaped by it.', tone: 'orange' },
    ],
    getHeadline: 'What you actually get',
    getBullets: [
      { title: 'Fit consultation', detail: 'A working call with a licensed GC — not a sales pitch.' },
      { title: 'Bid risk read', detail: 'What’s missing, what’s soft, what to push back on.' },
      { title: 'Execution readiness check', detail: 'Whether the project is set up for the contractor.' },
      { title: 'Written direction', detail: 'A clear recommendation after the call.' },
    ],
    deliverableTitle: 'Contractor Fit Consultation',
    deliverableSubtitle: '123 Main St · Charlotte, NC',
    deliverable: [
      {
        heading: 'Bid risk read',
        items: ['Contractor A: scope soft on demolition', 'Contractor B: $14K underbudgeted on rough-in', 'Both: no allowances itemized'],
      },
      {
        heading: 'Fit assessment',
        items: ['Project complexity: medium-high', 'Right fit: licensed GC w/ permit admin'],
      },
      {
        heading: 'Recommendation',
        items: ['Push Contractor A for detailed allowances', 'Add a 15% contingency line'],
      },
    ],
    processSteps: [
      { title: 'Submit the project', detail: 'Scope notes, photos, and any contractor bids you have.' },
      { title: 'We schedule the call', detail: 'A working consultation with a licensed GC.' },
      { title: 'You get direction', detail: 'Written follow-up within 1 business day of the call.' },
    ],
    testimonials: [
      {
        quote: 'They did not try to sell us a huge scope we did not need. Just told us what to do next and why.',
    ...
    valueStack: [
      ...
      'Read on contractor fit + bid risk',
      'Execution readiness check',
      'Specific push-back points for negotiation',
      'Written follow-up within 1 business day',
      'Email follow-up if anything is unclear',
      'Money-back if we cannot give you a clear answer',
    ],
